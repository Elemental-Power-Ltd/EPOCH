...
const std::string EPOCH_VERSION = "3.10.0";
...
struct ReportData {
	...
	// TempSum intermediary calculations
	year_TS _TempSum_elec_e;
	year_TS _TempSum_heat_h;
	year_TS _TempSum_DHW_load_h;
};
