...
class TestClearBundleCache:
    @pytest.mark.asyncio
    async def test_clear_cache(self, mocker: MockerFixture) -> None:
        """Test that "/clear-bundle-cache" clears the clients LRU cache."""
        ...
        response = await client.post(url="/clear-bundle-cache", params={"bundle_id": str(321)})
