...
class BayesianHyperParam(NSGA2HyperParam):
    ...
    n_init_samples: PositiveInt = (
        Field(examples=[5, 10], description="Number of evaluations to initialise model.", default=5),
    )
    num_restarts: PositiveInt = (
        Field(examples=[2, 10], description="Number of restarts of the acquisition function optimisation process.", default=10),
    )
