...
sudo -u postgres pg_dump -t "client_info.*" --data-only --attribute-inserts elementaldb  > elementaldb_client_info.sql
sudo -u postgres pg_dump -t "client_meters.*" --data-only elementaldb  > elementaldb_client_meters.sql