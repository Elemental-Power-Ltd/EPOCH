...
sudo -u postgres pg_dump -t "client_meters.metadata" -t "client_meters.electricity_meters" -t "client_meters.gas_meters" --data-only elementaldb --no-comments > elementaldb_client_meters.sql