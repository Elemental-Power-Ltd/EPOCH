...
DELETE FROM client_info.site_baselines
WHERE baseline_id IN (
    '019c4cab-6f84-701c-b97f-f799c8b454f5',
    '019c4cab-9f3f-71dd-842b-435279f806b8',
    '019c4cab-bbec-7556-87f3-f6a94e789de0'
);

DELETE FROM client_info.solar_locations
WHERE renewables_location_id IN (
...
DELETE FROM client_meters.metadata
WHERE dataset_id IN (
    '019c4cab-e8b6-7003-a22f-c7a82234b27d',
...
DELETE FROM client_meters.electricity_meters
WHERE dataset_id IN (
    '019c4cab-e8b6-7003-a22f-c7a82234b27d',
    '019c4cab-f9fd-7463-953f-1ab5e390c9cc',
    '019c4cac-9c36-7fc9-8895-076b1753a52f',
...
DELETE FROM client_meters.gas_meters
WHERE dataset_id IN (
    '019c4cab-e8b6-7003-a22f-c7a82234b27d',
    '019c4cab-f9fd-7463-953f-1ab5e390c9cc',
    '019c4cac-9c36-7fc9-8895-076b1753a52f',
