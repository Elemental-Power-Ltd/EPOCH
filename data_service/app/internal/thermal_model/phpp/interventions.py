...
THIRD_PARTY_INTERVENTIONS = {
    ...
    "Replacement External Windows": CostedIntervention(acts_on={StructuralArea.WindowArea}, cost=1001.83, u_value=2.4),
    "Secondary Glazing": CostedIntervention(acts_on={StructuralArea.WindowArea}, cost=275.37, u_value=2.9),
    "Fineo Glazing": CostedIntervention(acts_on={StructuralArea.WindowArea}, cost=586.74, u_value=0.7),
    ...
    "Mechanical Ventilation and Heat Recovery": CostedIntervention(
        acts_on={StructuralArea.FloorArea}, cost=117.59, u_value=None
    ),
