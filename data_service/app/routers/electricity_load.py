...
from app.dependencies import DatabasePoolDep, VaeDep
from app.internal.elec_meters import daily_to_hh_eload, day_type, load_all_scalers, monthly_to_daily_eload
from app.internal.epl_typing import DailyDataFrame, MonthlyDataFrame, RecordMapping
...
async def generate_electricity_load(
    params: ElectricalLoadRequest, vae: VaeDep, pool: DatabasePoolDep
