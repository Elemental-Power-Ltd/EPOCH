...
class Building(BaseModel):
    ...
    age: float = Field(default=0, description="The age of this component.", ge=0.0, title="Age")
...
class EnergyStorageSystem(BaseModel):
    capacity: float = Field(default=20.0, description="Battery capacity in kWh.", gt=0.0, title="Capacity")
...
class PydanticTaskData(BaseModel):
    building: Building | None = Field(
        default=None,
        description="A component to represent the physical building structure and its usage demands.",
        title="Building",
    )
    data_centre: None = Field(default=None, description="A Data Centre", title="Data Centre")
    domestic_hot_water: DomesticHotWater | None = Field(default=None, title="Domestic Hot Water")
    electric_vehicles: None = Field(default=None, title="EV Chargers")
    energy_storage_system: EnergyStorageSystem | None = Field(default=None, title="Energy Storage System")
...
class Config(BaseModel):
    ...
    capex_model: Jsonable | None = Field(
        default=None,
        description="A weakly typed cost model that is passed directly through to EPOCH.",
    )
    opex_model: Jsonable | None = Field(
        default=None,
        description="A weakly typed cost model that is passed directly through to EPOCH.",
    )
